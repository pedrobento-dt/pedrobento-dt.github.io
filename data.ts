...
const PORTUGUESE_DATA: AppData = {
  ...
  profile: {
    ...
    photoUrl: 'https://picsum.photos/400/400', // Replace with your actual photo URL
...
export const getData = (lang: Language) => lang === 'pt' ? PORTUGUESE_DATA : ENGLISH_DATA;